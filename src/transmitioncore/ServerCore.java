...
public class ServerCore {
	...
	/*
	 * ServerCore类是用来处理分发数据的类是整个socket通讯包的核心 该类应该拥有的功能有： 建立socket监听 创建线程池 分发数据
	 * 创建user对象
	 */
	/*
	 * 创建线程池的时候应该注意 由于受到不同设备的性能限制 所以应该写出多种线程池的创建方式 以满足不同设备的性能需求
	 */
	/******************** 变量表 *********************/
	/******************** 对象定义变量表 *********************/
	...
	/*
	 * 建立Scoket并监听的函数 监听端口为 portnumber
	 */
	...
	/*
	 * 建立线程池 要建立两种线程池 第一种是fixed线程池拥有固定的线程数量 第二种是cached线程池拥有无限的线程数量
	 */
